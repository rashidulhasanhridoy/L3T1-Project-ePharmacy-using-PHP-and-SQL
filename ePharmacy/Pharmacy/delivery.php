...
<html>
	<head>
		<title>ePharmacy | Delivery</title>
                ...
                <div class = "row">
                    ...
                    <?php endif ?>
						...
						<h6>Select a Order</h6>
                            ...
                            $query = "select distinct orderNumber from $tableName where submit = 3 and pharmacyUserName = '$name'";
                    ...
                    if(isset($_POST['selectOrder'])){
                     ...
                     $conn = new mysqli($servername, $username, $password, $dbname);
						...
						//Ready Order
                            ...
                            $sql = "Update orders set submit = 4, status = 'received' where orderNumber = '$orderNumber'";
							mysqli_query($db, $sql);	
							echo $orderNumber." is delivered!";
							...
							<button type = "submit" class = "btn btn-primary" name  = "deliverOrder" onclick="">Deliver</button>
                        </div>
                        </form>
					...
					//ordersTable		 
                        ...
                        $name = $_SESSION['userName'];
                        $sql = "SELECT distinct orderNumber, customerUserName, customerName,customerPhoneNumber, orderDate, status from orders where pharmacyUserName = '$name' and submit = 3";
