	...
	if(isset($_POST['changePassword'])){
        ...
        if($newPassword != $confirmPassword){
         ...
         if(count($errors) == 0){
			...
			$sql = "UPDATE pharmacy set password = '$password' where userName = '$name'";
			mysqli_query($db, $sql);
...
<html>
	<head>
		<title>ePharmacy | Change Pharmacy Password</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <?php endif ?>
                       ...
                       <!-- Search Customer -->
                        <p ><?php
                            ...
                            $sql = "SELECT name, email, phoneNumber, userName, pharmacyName, drugLicenseNumber, joinDate FROM pharmacy where userName = '$name'";
                    ...
                    <div class = "col-md-7 register-right">
                        <h2><br><br>Change Pharmacy Password</h2>
                        <form method = "post" action = "adminChangePharmacyPassword.php">
                        <!-- display errors -->
		                 <?php include('errors.php')?>
                        <div class = "register-form" >
                            <div class = "form-group">
                                <br><input type = "text" class = "form-control" name = "Name" placeholder="Enter Pharmacy Username" value = "<?php echo $name; ?>">
                            </div>
