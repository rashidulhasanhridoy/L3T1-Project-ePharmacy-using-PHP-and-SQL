        ...
        <div class = "row">
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <?php endif ?>
                        <a href="pharmacyReveiw.php"><button type = "button" class = "btn btn-primary" >Back</button></a>
						<br>
						<br>	 
		              </div>
						...
						if(isset($_POST['confirm'])){
								...
								$sql = "UPDATE orders set customerReveiw = '$reveiw' WHERE orderNumber = '$orderNo'";
								mysqli_query($db, $sql);
								echo "updated!";
								header('location: pharmacyReveiw.php');
							}
                    ...
                    <div class = "col-md-7 register-right">
                         ...
                         <form method = "post" action = "pharmacyGiveReveiw.php">
                        <!-- display errors -->
