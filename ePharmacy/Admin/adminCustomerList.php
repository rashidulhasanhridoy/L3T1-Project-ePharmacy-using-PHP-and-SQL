                ...
                <div class = "row">
                    ...
                    <?php endif ?>
                        ...
                        <p ><?php
                            ...
                            $sql = "SELECT userName, name, gender, email, phoneNumber,  buy FROM users where userName = '$name'";
                            $result = $conn->query($sql);

                            if ($result->num_rows > 0) {
                                // output data of each row
                                while($row = $result->fetch_assoc()) {
                                    echo "<br>Username: " . $row["userName"]."<br>Name: " . $row["name"]."<br>Gender: " . $row["gender"]."<br>Email: " . $row["email"]."<br>Phone Number: " . $row["phoneNumber"]."<br>Buy: " . $row["buy"]. "<br>";
                        ...
                        <form method = "post" action = "adminCustomerList.php">
                        <!-- display errors -->
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        $sql = "SELECT userId, userName, name, gender, email, phoneNumber, joinDate, buy FROM users";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No customer added in database!";
                        }
