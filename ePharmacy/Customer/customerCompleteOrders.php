...
<html>
	<head>
		<title>ePharmacy | Completed Orders</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                         ...
                         <form method = "post" action = "customerCompleteOrders.php">
                        <!-- display errors -->
							 <br>
							 <br>
						...
						<h6>Select a Order</h6>
                            ...
                            $query = "select distinct orderNumber from $tableName where submit = 4 and customerUserName = '$name'";
                        ...
                        ?>
                            ...
                            <div class = "form-group">
							 ...
							 <button type = "submit" class = "btn btn-primary" name  = "selectOrder" onclick="myFunction()">See Details</button>
							...
							if(mysqli_num_rows($result) > 0)
							{
							  ...
							  {	
                               echo "<br>Customer Reveiw: " . $row["customerReveiw"];
								echo "<br>Customer Reveiw 0 means, pharmacy authority don't give you reveiw for this order yet. Pharmacy Reveiw 0 means, you don't give reveiw for this order yet. Go Reveiw page & give reveiw.";  
							  }  
							}
                        } else {
                            echo "";
