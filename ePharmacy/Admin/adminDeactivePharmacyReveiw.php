                ...
                <div class = "row">
                    ...
                    <?php endif ?>
                        ...
                        <p ><?php
                            ...
                            $sql = "Update pharmacy set sell = 'off' where userName = '$name'";
                        ...
                        <form method = "post" action = "adminDeactivePharmacyReveiw.php">
                        <!-- display errors -->
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        if ($conn->connect_error) {
                      	...
                      	$sql = "SELECT pharmacyUserName, pharmacyName, phoneNumber, avg(pharmacyReveiw) FROM orders group by pharmacyName";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["pharmacyUserName"]. "</td><td>" . $row["pharmacyName"]. "</td><td>" . $row["phoneNumber"]. "</td><td>" . $row["avg(pharmacyReveiw)"]. "</td></tr>";
                            }
                            echo "</table>";
                        } else {
                            echo "No active pharmacy (reveiw less than 3)!";
                        }
