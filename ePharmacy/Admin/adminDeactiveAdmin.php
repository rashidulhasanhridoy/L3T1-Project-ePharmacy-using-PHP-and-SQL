...
<html>
	<head>
		<title>ePharmacy | Deactive Admin</title>
                ...
                <div class = "row">
                    ...
                    <?php endif ?>
                        ...
                        <p ><?php
                            ...
                            $sql = "Update admin set request = 0 where userName = '$name'";
                            $result = $conn->query($sql);
                            $sql2 = "insert into deactiveinfo (type, userName, reason, date, adminName) values('admin', '$name', 'vacation', '$date', '$by')";    
                        ...
                        <form method = "post" action = "adminDeactiveAdmin.php">
                        <!-- display errors -->
                        ...
                        <div class = "register-form" >
                            ...
                            <button type = "submit" class = "btn btn-primary" name  = "deactiveAdmin" onclick="">Deactive</button>
                    ...
                    <div class = "col-md-7 register-right">
                        ...
                        $sql = "SELECT name, userName, email, phoneNumber, joinDate FROM admin where request = 1";
