...
<?php
	...
	if(isset($_POST['changePassword'])){
        ...
        $user_check_query = "SELECT * FROM pharmacy WHERE userName = '$userName' LIMIT 1";
         ...
         if(count($errors) == 0){
			...
			$sql = "UPDATE pharmacy set password = '$password' where userName = '$userName'";
			mysqli_query($db, $sql);
			header('location: pharmacyLogin.php'); // redirect to homepage
