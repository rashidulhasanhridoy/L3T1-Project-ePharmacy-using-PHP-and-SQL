...
<html>
	<head>
		<title>ePharmacy | Submitted Orders</title>
            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <div class = "col-md-7 register-right">
                         ...
                         <form method = "post" action = "customerConfirmdOrders.php">
                        <!-- display errors -->
							 <br>
							 <br>
						...
						<h6>Select a Order</h6>
                            ...
                            $query = "select distinct orderNumber from $tableName where submit in (1, 3) and customerUserName = '$name'";
