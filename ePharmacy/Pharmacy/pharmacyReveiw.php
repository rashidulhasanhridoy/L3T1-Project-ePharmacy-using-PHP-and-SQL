            ...
            <div class = "col-md-10 offset = md - 1">
                <div class = "row">
                    ...
                    <?php  if (isset($_SESSION['userName'])) : ?>
                       <p>Welcome pharmacy, <strong><?php echo $_SESSION['userName']; ?></strong>
						   <br>
                        <a href="pharmacyLogin.php" style="color: red;">Logout</a></p>
                    ...
                    <?php endif ?>
						...
						<form method = "post" action = "pharmacyReveiw.php">
                        <!-- display errors -->
						...
						<h6>Select a order to give reveiw.</h6>
                            ...
                            $query = "select distinct orderNumber from $tableName where submit = 4 and pharmacyUserName = '$name' and customerReveiw = 0";
                        ...
                        ?>
                            ...
                            <div class = "form-group">
								...
								if(isset($_POST['selectOrder'])){
									...
									header('location: pharmacyGiveReveiw.php'); 
					...
					//ordersTable		 
                        ...
                        $name = $_SESSION['userName'];
                        $sql = "SELECT distinct orderNumber, customerUserName, customerName,customerPhoneNumber, orderDate, status, pharmacyReveiw, customerReveiw from orders where pharmacyUserName = '$name' and submit = 4";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["orderNumber"]. "</td><td>" . $row["customerUserName"]. "</td><td>" . $row["customerName"]. "</td><td>" . $row["customerPhoneNumber"]. "</td><td>" . $row["orderDate"]. "</td><td>" . $row["status"]. "</td><td>" . $row["pharmacyReveiw"]. "</td><td>" . $row["customerReveiw"]. "</td></tr>";
                            }
                            echo "</table>";
                        } else {
