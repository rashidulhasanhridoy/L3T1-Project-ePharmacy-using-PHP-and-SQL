...
<html>
	<head>
		<title>ePharmacy | Approve Pharmacy</title>
                ...
                <div class = "row">
                    ...
                    <?php endif ?>
                        ...
                        <p ><?php
                            ...
                            $sql = "Update pharmacy set request = 1 where userName = '$name'";
                        ...
                        <form method = "post" action = "adminApprovePharmacy.php">
                        <!-- display errors -->
                    ...
                    <div class = "col-md-7 register-right">
                        <h5>Pharmacy Approve Request List</h5>
                        <?php
                        $servername = "localhost";
                        $username = "root";
                        $password = "";
                        ...
                        $sql = "SELECT name, userName, email, phoneNumber, pharmacyName FROM pharmacy where request = 0";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No approve pharmacy request!";
                        }
